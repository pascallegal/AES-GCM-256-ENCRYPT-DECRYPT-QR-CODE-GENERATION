<p align="center">
<a href="https://coinmanager.fr/aes/index.html"><b>>>> Click here to try the app.<<< </b></a>
</p>
...
[**AES-GCM-256 Encryption/Decryption**](https://coinmanager.fr/aes/index.html)
...
- project/
    ...
    - qrcode/
        - index.html (for testing qrcode)
        - index.svg.html (for testing qrcode)
        - qrcode.js
